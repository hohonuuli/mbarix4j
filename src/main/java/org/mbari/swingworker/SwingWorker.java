 ...
 * org.mbari.swingworker. This was done to avoid version conflicts in projects 
 * that include both mbarix4j and the SwingWorker backport to JDK 5.
 */

package org.mbari.swingworker;
