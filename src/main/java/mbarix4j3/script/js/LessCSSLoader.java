...
/**
 * Converts a less file to css and returns the URL to the css file. Very useful
 * for JavaFX stuff.
 */
public class LessCSSLoader {
    ...
    public LessCSSLoader() {
        ...
        engine = mgr.getEngineByExtension("mbarix4j3/js");
    ...
    private static String createParserScript() {
        ...
        readFileContent(LessCSSLoader.class.getResource("/mbarix4j3/js/env.js"), b);
        readFileContent(LessCSSLoader.class.getResource("/mbarix4j3/js/less.js"), b);
        readFileContent(LessCSSLoader.class.getResource("/mbarix4j3/js/parser.js"), b);
