...
public class ActiveAppBeacon {
    ...
    private static final Logger log = Logger.getLogger(ActiveAppBeacon.class.getName());
    ...
    public ActiveAppBeacon(Collection<Integer> ports, final String pingMessage) {
        ...
        if (serverSocket == null) {
            ...
            beaconThread = null;
            log.warning("Failed to activate a ServerSocket for ActiveAppBeacon on any of the following ports: " + portMsg);
        }
        else {
    ...
    public void kill() {
        ...
        if (serverSocket != null) {
            try {
                ...
                log.fine("The beacon's ServerSocket threw an exception while killing the beacon. " +
