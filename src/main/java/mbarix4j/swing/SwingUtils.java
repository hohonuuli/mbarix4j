 ...
 * @version $Id: SwingUtils.java 429 2006-11-20 22:51:32Z hohonuuli $
 */
public class SwingUtils {
    ...
    /**
     * Creates a String suitable for displaying a keystroke on UI componenets.
     * @param key the KeyStroke to convert. For example it might be ctrl+
     * @return
     */
     ...
     * parsed by KeyStroke.getKeyStroke(). The method keyStrokeToString() returns
     * a string that is parseable by  KeyStroke.getKeyStroke(). However, there
     * is one keystroke that cannot be represented as a string that can be
     * parsed back to a keystroke - - a typed space character. In order to bind
     * an action to a typed space character,
